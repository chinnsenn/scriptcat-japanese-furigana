 ...
 * [OUTPUT]: 验证 1.1.1 元数据、ASCII 发布链接、Greasy Fork 说明、CI 质量门和标签 Release 产物路径
...
test("1.1.1 发布元数据指向正式 GitHub 仓库与可安装 Raw 产物", () => {
  ...
  assert.match(userscript, /^\/\/ @version\s+1\.1\.1$/m);
