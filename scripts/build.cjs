 ...
 * [OUTPUT]: 生成带 ScriptCat 元数据、1.1 语言区间过滤、视频防暂停和动态会话能力的 outputs/japanese-furigana.user.js
 * [POS]: scripts 的唯一构建入口，把可维护源码与早期守卫收敛为可安装单文件
